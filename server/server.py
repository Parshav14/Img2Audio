...
@app.get("/")
async def root():
    return {"message": "Vision2VoiceAI Backend is running! API endpoints available at /api"}

@app.get("/health")
async def health_check():
    return {"status": "healthy", "service": "Vision2VoiceAI Backend"}
...
app.add_middleware(
    ...
    allow_origins=os.environ.get('CORS_ORIGINS', 'https://Vision2Voice-ai.vercel.app,*').split(','),
    allow_methods=["*"],
    allow_headers=["*"],
)
